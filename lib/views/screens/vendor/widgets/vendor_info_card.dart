        ...
        children: [
          ...
          Container(
            ...
            decoration: BoxDecoration(
              ...
              image: DecorationImage(image: NetworkImage(logoImage), fit: BoxFit.cover, onError: (error, stackTrace) {}),
            ),
          ),
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(_stripHtml(description), style: const TextStyle(fontSize: 13, color: Colors.grey), maxLines: 6, overflow: TextOverflow.ellipsis),
                ],
              ),
            ),
          ),
