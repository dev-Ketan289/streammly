...
class _VendorDetailScreenState extends State<VendorDetailScreen> {
  ...
  void pushToCurrentTab(Widget page) {
    final navKey = Get.find<NavigationController>().navigatorKeys[Get.find<NavigationController>().selectedIndex];
            ...
            child: Column(
              ...
              children: [
                ...
                HeaderBanner(
                  ...
                  backgroundImage:
                      (widget.company.company?.bannerImage != null && widget.company.bannerImage!.isNotEmpty)
                      ...
                      return CategoryScroller(
                        categories: [
                          CategoryItem(
                            ...
                            onTap: () => pushToCurrentTab(VendorGroup(company: widget.company, subCategoryId: 2)),
                          ),
                      ...
                      categories:
                          subs.map((sub) {
                            return CategoryItem(
                              ...
                              onTap: () => pushToCurrentTab(VendorGroup(company: widget.company, subCategoryId: sub.id)),
                            );
                          }).toList(),
                    );
                  },
