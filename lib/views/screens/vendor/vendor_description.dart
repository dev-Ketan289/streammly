          ...
          if (bannerUrl != null &&
            ...
            bannerWidget = Image.network(
              ...
              errorBuilder: (context, error, stackTrace) {
                return Image.asset('assets/images/newBorn.jpg',
                    fit: BoxFit.cover);
              },
            );
          } else {
            bannerWidget =
                Image.asset('assets/images/newBorn.jpg', fit: BoxFit.cover);
          }

          String distanceText = company.distanceKm != null
      ...
      builder: (context) {
        return Padding(
          padding: EdgeInsets.fromLTRB(
              screenWidth * 0.05, 20, screenWidth * 0.05, 30),
            ...
            child: Column(
              ...
              children: [
                    ...
                    if (company.rating != null)
                      Container(
                        ...
                        decoration: BoxDecoration(
                            color: theme.primaryColor,
                            borderRadius: BorderRadius.circular(6)),
                        child: Text("${company.rating!.toStringAsFixed(1)} ★",
                            style: theme.textTheme.bodySmall
                                ?.copyWith(color: Colors.white)),
                      ),
                  ],
                ...
                Align(
                    ...
                    child: Text(company.categoryName ?? 'Photographer',
                        style: theme.textTheme.bodySmall
                  ...
                  children: const [
                    Column(
                      ...
                      children: [
                        ...
                        SizedBox(height: 4),
                        Row(children: [
                          Icon(Icons.circle, size: 6, color: Colors.teal),
                          SizedBox(width: 6),
