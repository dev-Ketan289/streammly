                  ...
                  GestureDetector(
                    onTap: () {
                      final selectedCategory = categoryController.categories
                          .firstWhereOrNull(
                            (e) => e.title == widget.selectedCategories.first,
                          );
                      if (selectedCategory != null) {
                        Get.to(
                          () => CompanyLocatorMapScreen(
                                  ...
                                  children:
                                      companies.map((company) {
                                        ...
                                        return GestureDetector(
                                          onTap: () {
                                            setState(() {
                                              if (_selectedVendorIds.contains(
                                                companyId,
                                              )) {
                                                _selectedVendorIds.remove(
                                                  companyId,
                                                );
                                              } else {
                                                _selectedVendorIds.add(
                                                  companyId,
                                                );
                                              }
                                            });
                  ...
                  return Column(
                    ...
                    children:
                        companiesByCategory.entries.expand((entry) {
                          ...
                          return companies
                              .where(
                                (company) => _selectedVendorIds.contains(
                                  company.id.toString(),
                                ),
                              )
                              .map((company) {
