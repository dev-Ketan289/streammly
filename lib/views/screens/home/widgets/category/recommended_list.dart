          ...
          return InkWell(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                boxShadow: [BoxShadow(color: theme.shadowColor.withValues(alpha: .05), blurRadius: 3, offset: const Offset(1, 2))],
              ),
              child: Column(
                ...
                children: [
                  Stack(
                    children: [
                      ...
                      Positioned(top: 8, right: 8, child: GestureDetector(onTap: () {}, child: Icon(Icons.favorite, size: itemWidth * 0.12, color: theme.colorScheme.onPrimary))),
                    ],
                  ),
                  Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        Row(
                          children: [
                            Expanded(
                              child: Text(
                                companyName,
                                style: TextStyle(fontWeight: FontWeight.bold, fontSize: itemWidth * 0.09, color: theme.colorScheme.onSurface, overflow: TextOverflow.ellipsis),
                              ),
                            ),
                            Container(
                              ...
                              child: Text("$rating ★", style: TextStyle(color: theme.colorScheme.onPrimary, fontSize: itemWidth * 0.075)),
                            ),
                          ],
                        ),
                        ...
                        Row(
                          children: [
                            Icon(Icons.access_time, size: itemWidth * 0.085, color: theme.colorScheme.onSurfaceVariant),
                            SizedBox(width: itemWidth * 0.025),
                            Expanded(child: Text(time, style: TextStyle(fontSize: itemWidth * 0.075, color: theme.colorScheme.onSurfaceVariant), overflow: TextOverflow.ellipsis)),
                          ],
                        ),
                        SizedBox(height: itemWidth * 0.015),
                        Row(
                          children: [
                            Icon(Icons.location_on, size: itemWidth * 0.085, color: theme.colorScheme.onSurfaceVariant),
                            SizedBox(width: itemWidth * 0.025),
                            Expanded(
                              child: Text(distanceText, style: TextStyle(fontSize: itemWidth * 0.075, color: theme.colorScheme.onSurfaceVariant), overflow: TextOverflow.ellipsis),
                            ),
                          ],
                        ),
                      ],
