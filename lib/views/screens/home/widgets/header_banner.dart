...
>>>>>>> c023c8ed04a6e4749fc979fab105d594398e9322
                        },
                      ),
                      const SizedBox(width: 8),
                      Expanded(
                    ...
                    child: SingleChildScrollView(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          if (widget.specialized != null &&
                              widget.specialized!.isNotEmpty) ...[
                            Padding(
                              padding: const EdgeInsets.symmetric(
                                horizontal: 16,
                              ),
                              ...
                              child: Wrap(
                                ...
                                children: [
                                  for (
                                    int i = 0;
                                    i <
                                        (widget.specialized!.length > 2
                                            ? 2
                                            : widget.specialized!.length);
                                    i++
                                  )
                                    Chip(
                                      backgroundColor:
                                  ...
                                  if (widget.specialized!.length > 2)
                                    Chip(
                                      ...
                                      label: Text(
                                        "+${widget.specialized!.length - 2} more",
                                        style: theme.textTheme.bodySmall
                                            ?.copyWith(
                                              color: Colors.indigo,
                                              fontSize: 12,
