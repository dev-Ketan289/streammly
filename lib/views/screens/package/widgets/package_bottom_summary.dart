              ...
              onPressed:
                  selectedPackages.isEmpty
                      ...
                      : () {
                        ...
                        log(
                          "${selectedPackages.firstOrNull.toString()}",
                          name: "padflkjsdljlfsdjl;kj",
                        );
                        ...
                        // Get.to(() => BookingPage(), arguments: {'packages': selectedPackages, 'companyLocations': companyLocations});
                      },
              child: Text(
                selectedPackages.isEmpty
