...
class ExtraAddOnsPage extends StatefulWidget {
  ...
  const ExtraAddOnsPage({super.key, required this.packageId, required this.studioId});
                ...
                GestureDetector(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      Icon(_showAddOns ? Icons.remove_circle_outline : Icons.add_circle_outline, color: const Color(0xff2864A6)),
                    ],
                  ),
                ),
                    ...
                    child: ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        if (item.coverImage != null && item.coverImage!.isNotEmpty) {
                          ...
                          imageWidget = Container(height: 50, width: 50, color: Colors.grey[200], child: const Icon(Icons.image));
                        }
                              ...
                              children: [
                                ...
                                Expanded(
                                  child: Column(
                                    crossAxisAlignment: CrossAxisAlignment.start,
                                    children: [
                                      Text(item.productTitle, style: theme.textTheme.bodyLarge?.copyWith(fontWeight: FontWeight.bold), overflow: TextOverflow.ellipsis),
                                      const SizedBox(height: 2),
                                      Text(item.description ?? "", style: theme.textTheme.bodySmall?.copyWith(color: Colors.grey), overflow: TextOverflow.ellipsis),
                                      const SizedBox(height: 2),
                                      Text('Shoot Duration : 1', style: theme.textTheme.bodySmall?.copyWith(color: Colors.grey)),
                                    ],
                                  ),
                                ),
                                ...
                                Column(
                                  ...
                                  children: [
                                    Text(item.price != null ? 'Rs ${item.price} /-' : 'Rs -- /-', style: theme.textTheme.bodyMedium?.copyWith(fontWeight: FontWeight.bold)),
