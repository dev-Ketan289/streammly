      ...
      body: Padding(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            ...
            boxShadow: [BoxShadow(color: Colors.grey.withAlpha(30), blurRadius: 8)],
          ),
          child: GetBuilder<PackagesController>(
            builder: (controller) {
              ...
              final mainTitle = (resp?.mainTitles.isNotEmpty == true)
                  ...
                  GestureDetector(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        Icon(
                          _showItems ? Icons.remove_circle_outline : Icons.add_circle_outline,
                          color: const Color(0xff2864A6),
                        ),
                      ],
                    ),
                              ...
                              TextButton(
                                ...
                                child: Text(
                                  ...
                                  style: theme.textTheme.labelLarge?.copyWith(
                                    fontWeight: FontWeight.bold,
                                    color: selected ? theme.primaryColor : const Color(0xff2864A6),
                                  ),
                                ),
                              ),
                            ],
