...
class _PackageFormCardState extends State<PackageFormCard> {
  ...
  Widget build(BuildContext context) {
    ...
    TextEditingController studioAddController =
    TextEditingController(text: widget.package['address'] ?? '305/A, Navneet Building, Saivihar Road, Bhandup (W), Mumbai 400078.');
    final controller = Get.find<BookingController>();
                                ...
                                if (img != null && img.isNotEmpty) {
                                  ...
                                  return Image.network(
                                    ...
                                    errorBuilder: (c, o, e) => Container(
                                        height: 50, width: 50, color: Colors.grey[300], child: const Icon(Icons.broken_image)),
                                  );
                                }
