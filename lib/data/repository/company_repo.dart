...
class CompanyRepo {
  ...
  Future<List<CompanyLocation>> fetchCompaniesByCategory(int categoryId, {required double latitude, required double longitude}) async {
    final response = await apiClient.getData("api/v1/company/getcompanyslocations/$categoryId?latitude=$latitude&longitude=$longitude");
